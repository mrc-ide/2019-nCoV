---
title: "initial estimate of number of cases in Wuhan City"
author: "Natsuko Imai"
...
library(readxl)
#library(orderly)
#orderly_run("A_prepare_vhf_linelist", parameters = list(file_type = "xlsx"))
#orderly_test_start("A_prepare_vhf_linelist", parameters = list(file_type = "xlsx"))
...
extract_ci <- function(N, cases, prob_travel_during_window, threshold = 1.2){
